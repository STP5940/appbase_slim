...
proto.types.ExecutionStatus.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, proto.types.Aborted.serializeBinaryToWriter);
    }
...
proto.types.ExecutionStatus.prototype.getAborted = function () {
    return /** @type{?proto.types.Aborted} */ (jspb.Message.getWrapperField(this, proto.types.Aborted, 2));
};
