 ...
 */
const methodDescriptor_Mempool_AddTransactionWithValidation = new grpc.web.MethodDescriptor('/mempool.Mempool/AddTransactionWithValidation', grpc.web.MethodType.UNARY, proto.mempool.AddTransactionWithValidationRequest, proto.mempool.AddTransactionWithValidationResponse, 
 ...
 *   !proto.mempool.AddTransactionWithValidationResponse>}
 */
const methodInfo_Mempool_AddTransactionWithValidation = new grpc.web.AbstractClientBase.MethodInfo(proto.mempool.AddTransactionWithValidationResponse, 
/** @param {!proto.mempool.AddTransactionWithValidationRequest} request */
function (request) {
    return request.serializeBinary();
}, proto.mempool.AddTransactionWithValidationResponse.deserializeBinary);
...
proto.mempool.MempoolClient.prototype.addTransactionWithValidation =
    function (request, metadata, callback) {
        return this.client_.rpcCall(this.hostname_ +
            '/mempool.Mempool/AddTransactionWithValidation', request, metadata || {}, methodDescriptor_Mempool_AddTransactionWithValidation, callback);
    };
/**
 * @param {!proto.mempool.AddTransactionWithValidationRequest} request The
 *     request proto
...
proto.mempool.MempoolPromiseClient.prototype.addTransactionWithValidation =
    function (request, metadata) {
        return this.client_.unaryCall(this.hostname_ +
            '/mempool.Mempool/AddTransactionWithValidation', request, metadata || {}, methodDescriptor_Mempool_AddTransactionWithValidation);
    };
/**
 * @const
 * @type {!grpc.web.MethodDescriptor<
 ...
 */
const methodDescriptor_Mempool_GetBlock = new grpc.web.MethodDescriptor('/mempool.Mempool/GetBlock', grpc.web.MethodType.UNARY, proto.mempool.GetBlockRequest, proto.mempool.GetBlockResponse, 
...
proto.mempool.MempoolClient.prototype.getBlock =
    function (request, metadata, callback) {
        return this.client_.rpcCall(this.hostname_ +
            '/mempool.Mempool/GetBlock', request, metadata || {}, methodDescriptor_Mempool_GetBlock, callback);
    };
/**
 * @param {!proto.mempool.GetBlockRequest} request The
 *     request proto
...
proto.mempool.MempoolPromiseClient.prototype.getBlock =
    function (request, metadata) {
        return this.client_.unaryCall(this.hostname_ +
            '/mempool.Mempool/GetBlock', request, metadata || {}, methodDescriptor_Mempool_GetBlock);
    };
/**
 * @const
 * @type {!grpc.web.MethodDescriptor<
 ...
 */
const methodDescriptor_Mempool_CommitTransactions = new grpc.web.MethodDescriptor('/mempool.Mempool/CommitTransactions', grpc.web.MethodType.UNARY, proto.mempool.CommitTransactionsRequest, proto.mempool.CommitTransactionsResponse, 
 ...
 *   !proto.mempool.CommitTransactionsResponse>}
 */
const methodInfo_Mempool_CommitTransactions = new grpc.web.AbstractClientBase.MethodInfo(proto.mempool.CommitTransactionsResponse, 
/** @param {!proto.mempool.CommitTransactionsRequest} request */
function (request) {
    return request.serializeBinary();
}, proto.mempool.CommitTransactionsResponse.deserializeBinary);
...
proto.mempool.MempoolClient.prototype.commitTransactions =
    function (request, metadata, callback) {
        return this.client_.rpcCall(this.hostname_ +
            '/mempool.Mempool/CommitTransactions', request, metadata || {}, methodDescriptor_Mempool_CommitTransactions, callback);
    };
/**
 * @param {!proto.mempool.CommitTransactionsRequest} request The
 *     request proto
...
proto.mempool.MempoolPromiseClient.prototype.commitTransactions =
    function (request, metadata) {
        return this.client_.unaryCall(this.hostname_ +
            '/mempool.Mempool/CommitTransactions', request, metadata || {}, methodDescriptor_Mempool_CommitTransactions);
    };
/**
 * @const
 * @type {!grpc.web.MethodDescriptor<
 ...
 */
const methodDescriptor_Mempool_HealthCheck = new grpc.web.MethodDescriptor('/mempool.Mempool/HealthCheck', grpc.web.MethodType.UNARY, proto.mempool.HealthCheckRequest, proto.mempool.HealthCheckResponse, 
 ...
 *   !proto.mempool.HealthCheckResponse>}
 */
const methodInfo_Mempool_HealthCheck = new grpc.web.AbstractClientBase.MethodInfo(proto.mempool.HealthCheckResponse, 
/** @param {!proto.mempool.HealthCheckRequest} request */
function (request) {
    return request.serializeBinary();
}, proto.mempool.HealthCheckResponse.deserializeBinary);
...
proto.mempool.MempoolClient.prototype.healthCheck =
    function (request, metadata, callback) {
        return this.client_.rpcCall(this.hostname_ +
            '/mempool.Mempool/HealthCheck', request, metadata || {}, methodDescriptor_Mempool_HealthCheck, callback);
    };
/**
 * @param {!proto.mempool.HealthCheckRequest} request The
 *     request proto
...
proto.mempool.MempoolPromiseClient.prototype.healthCheck =
    function (request, metadata) {
        return this.client_.unaryCall(this.hostname_ +
            '/mempool.Mempool/HealthCheck', request, metadata || {}, methodDescriptor_Mempool_HealthCheck);
    };
