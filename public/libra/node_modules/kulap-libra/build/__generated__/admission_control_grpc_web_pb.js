 ...
 */
const methodDescriptor_AdmissionControl_SubmitTransaction = new grpc.web.MethodDescriptor('/admission_control.AdmissionControl/SubmitTransaction', grpc.web.MethodType.UNARY, proto.admission_control.SubmitTransactionRequest, proto.admission_control.SubmitTransactionResponse, 
 ...
 *   !proto.admission_control.SubmitTransactionResponse>}
 */
const methodInfo_AdmissionControl_SubmitTransaction = new grpc.web.AbstractClientBase.MethodInfo(proto.admission_control.SubmitTransactionResponse, 
/** @param {!proto.admission_control.SubmitTransactionRequest} request */
function (request) {
    return request.serializeBinary();
}, proto.admission_control.SubmitTransactionResponse.deserializeBinary);
...
proto.admission_control.AdmissionControlClient.prototype.submitTransaction =
    function (request, metadata, callback) {
        return this.client_.rpcCall(this.hostname_ +
            '/admission_control.AdmissionControl/SubmitTransaction', request, metadata || {}, methodDescriptor_AdmissionControl_SubmitTransaction, callback);
    };
/**
 * @param {!proto.admission_control.SubmitTransactionRequest} request The
 *     request proto
...
proto.admission_control.AdmissionControlPromiseClient.prototype.submitTransaction =
    function (request, metadata) {
        return this.client_.unaryCall(this.hostname_ +
            '/admission_control.AdmissionControl/SubmitTransaction', request, metadata || {}, methodDescriptor_AdmissionControl_SubmitTransaction);
    };
/**
 * @const
 * @type {!grpc.web.MethodDescriptor<
 ...
 */
const methodDescriptor_AdmissionControl_UpdateToLatestLedger = new grpc.web.MethodDescriptor('/admission_control.AdmissionControl/UpdateToLatestLedger', grpc.web.MethodType.UNARY, get_with_proof_pb.UpdateToLatestLedgerRequest, get_with_proof_pb.UpdateToLatestLedgerResponse, 
 ...
 *   !proto.types.UpdateToLatestLedgerResponse>}
 */
const methodInfo_AdmissionControl_UpdateToLatestLedger = new grpc.web.AbstractClientBase.MethodInfo(get_with_proof_pb.UpdateToLatestLedgerResponse, 
/** @param {!proto.types.UpdateToLatestLedgerRequest} request */
function (request) {
    return request.serializeBinary();
}, get_with_proof_pb.UpdateToLatestLedgerResponse.deserializeBinary);
...
proto.admission_control.AdmissionControlClient.prototype.updateToLatestLedger =
    function (request, metadata, callback) {
        return this.client_.rpcCall(this.hostname_ +
            '/admission_control.AdmissionControl/UpdateToLatestLedger', request, metadata || {}, methodDescriptor_AdmissionControl_UpdateToLatestLedger, callback);
    };
/**
 * @param {!proto.types.UpdateToLatestLedgerRequest} request The
 *     request proto
...
proto.admission_control.AdmissionControlPromiseClient.prototype.updateToLatestLedger =
    function (request, metadata) {
        return this.client_.unaryCall(this.hostname_ +
            '/admission_control.AdmissionControl/UpdateToLatestLedger', request, metadata || {}, methodDescriptor_AdmissionControl_UpdateToLatestLedger);
    };
